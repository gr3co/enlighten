...
blinky.obj: ../blinky.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.2/bin/armcl" -mv7M3 --code_state=16 --abi=eabi -me -O2 --include_path="C:/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.2/include" --include_path="../driverlib" -g --define=DEBUG --define=CC2538_USE_ALTERNATE_INTERRUPT_MAP --display_error_number --diag_warning=225 --diag_wrap=off --gen_func_subsections=on --ual --preproc_with_compile --preproc_dependency="blinky.pp" $(GEN_OPTS__FLAG) "$<"
